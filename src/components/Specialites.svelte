<section class="flex justify-center py-24">
	<div class="flex flex-col">
		<div class="flex flex-col pb-16 items-center">
			<h3 class="uppercase text-xl md:text-3xl text-yellow-400 font-semibold">offre spécial</h3>
			<h2 class="uppercase font-bold my-6 text-2xl md:text-4xl">nos meilleurs services</h2>
		...
		<div class="flex flex-col md:flex-row max-w-screen-lg justify-center">
			<div class="px-4 flex ">
				...
				<div class="pl-6">
					...
					<p class="text-md md:text-lg font-lg pt-4">
